...
const VENDORS: Vendor[] = [
  { id: '1', name: 'Kaspersky', category: 'Endpoint Security', rating: 4.9, solutions: ['KSC', 'KATA', 'EDR'], website: 'kaspersky.ru' },
  { id: '2', name: 'Positive Technologies', category: 'Vulnerability Management', rating: 4.8, solutions: ['MaxPatrol', 'PT AF', 'NAD'], website: 'ptsecurity.com' },
  { id: '3', name: 'UserGate', category: 'NGFW', rating: 4.7, solutions: ['UserGate UTM', 'Log Analyzer'], website: 'usergate.com' },
  { id: '4', name: 'InfoWatch', category: 'DLP', rating: 4.6, solutions: ['Traffic Monitor'], website: 'infowatch.ru' },
  { id: '5', name: 'Check Point', category: 'Network Security', rating: 4.8, solutions: ['Quantum', 'Harmony'], website: 'checkpoint.com' },
  { id: '6', name: 'Solar Security', category: 'SOC/MSSP', rating: 4.7, solutions: ['Solar Dozor', 'Solar JSOC'], website: 'rt-solar.ru' },
];

const EXPERTS: Expert[] = [
  { id: '1', name: 'Иван Иванов', role: 'CISO', specialization: ['GRC', 'ISO 27001', 'Risk Management'], experience: '15 лет', contact: '@ivan_sec' },
  { id: '2', name: 'Анна Петрова', role: 'Security Architect', specialization: ['Cloud Security', 'AppSec', 'Zero Trust'], experience: '10 лет', contact: '@anna_arch' },
  { id: '3', name: 'Дмитрий Сидоров', role: 'Penetration Tester', specialization: ['Web Hacking', 'Red Teaming', 'OSINT'], experience: '8 лет', contact: '@dima_hack' },
  { id: '4', name: 'Елена Козлова', role: 'Legal Compliance', specialization: ['GDPR', '152-ФЗ', 'КИИ'], experience: '12 лет', contact: '@elena_law' },
];
...
const LogoSKFU = () => (
  <a href="https://www.ncfu.ru" target="_blank" rel="noopener noreferrer" className="transition-transform hover:scale-105 active:scale-95">
    <img 
      src="https://www.ncfu.ru/export/sites/ncfu/.galleries/images/logo-ncfu.png" 
      alt="СКФУ" 
      className="h-14 sm:h-20 w-auto object-contain drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]"
...
const LogoOTZI = () => (
  <a href="https://otzi.ncfu.ru" target="_blank" rel="noopener noreferrer" className="transition-transform hover:scale-105 active:scale-95">
    <img 
...
export default function App() {
  const [activeTab, setActiveTab] = useState<'calculator' | 'vendors' | 'experts'>('calculator');
    ...
    <div className="min-h-screen bg-[#080a0e] text-[#dde3f0] font-sans selection:bg-emerald-500/30">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-12">
        ...
        <header className="flex flex-col gap-8 mb-12">
          <div className="flex items-center justify-between p-8 bg-white/5 border border-white/10 rounded-3xl backdrop-blur-xl shadow-2xl relative overflow-hidden group">
            ...
            <LogoSKFU />
            <div className="hidden md:flex flex-col items-center text-center px-6 relative z-10">
              <div className="w-12 h-px bg-gradient-to-r from-transparent via-[#62708a] to-transparent mb-3 opacity-30" />
              <span className="text-[10px] uppercase tracking-[0.3em] text-emerald-400 font-black mb-2">Студенческий стартап</span>
              <span className="text-sm font-bold text-white/90 tracking-tight">Мандрица И.В. · Бугаева А.В ®</span>
              <span className="text-[9px] text-[#62708a] mt-2 font-medium italic tracking-wide">свидетельство о регистрации электронной программы</span>
              <div className="w-12 h-px bg-gradient-to-r from-transparent via-[#62708a] to-transparent mt-3 opacity-30" />
            </div>
            <LogoOTZI />
          </div>
          ...
          <div className="flex flex-col gap-8">
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8">
              <div className="flex flex-col gap-4 max-w-2xl">
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-500/10 border border-emerald-500/20 rounded-full text-[10px] uppercase tracking-[0.2em] text-emerald-400 w-fit font-bold">
                  <div className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
                  Professional Risk Assessment
                </div>
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-heading font-black tracking-tighter leading-[0.9] lg:leading-[0.8] uppercase">
                  Кибер<span className="text-transparent bg-clip-text bg-gradient-to-br from-emerald-400 via-cyan-400 to-blue-500 drop-shadow-[0_0_20px_rgba(52,211,153,0.3)]">Риски</span>
                  <span className="text-white/20 mx-2">/</span>
                  <span className="text-white">КИИ</span>
                  <span className="block text-base sm:text-lg font-bold text-[#62708a] mt-4 lg:mt-6 tracking-tight normal-case">
                    Учреждения, фирмы, организации <span className="text-white/40 font-light ml-2">v. 2.0</span>
                  </span>
                </h1>
                <p className="text-sm text-[#62708a] max-w-md leading-relaxed font-medium">
                  Интеллектуальная система оценки рисков ИБ со встроенным калькулятором бюджета. 
                  Базируется на 16-факторной модели, БДУ ФСТЭК и актуальных рыночных данных 2025–2026.
                </p>
              </div>
              
              <div className="flex flex-col gap-4 w-full lg:w-auto">
                <div className="flex items-center justify-between lg:justify-end gap-4 px-5 py-3 bg-[#0f1219]/50 border border-emerald-500/30 rounded-xl backdrop-blur-md shadow-[0_0_15px_rgba(52,211,153,0.1)]">
                  <div className="flex items-center gap-2">
                    <Calendar className="w-5 h-5 text-emerald-400" />
                    <span className="text-[11px] uppercase tracking-[0.2em] text-[#62708a] font-black">Обновление методологии:</span>
                  </div>
                  <span className="text-xl font-mono font-black text-emerald-400 drop-shadow-[0_0_10px_rgba(52,211,153,0.3)]">{currentDate}</span>
                </div>

                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 w-full">
                  <button 
                    onClick={() => setActiveTab('calculator')}
                    className={`flex flex-col items-center justify-center gap-1 p-3 sm:p-4 rounded-2xl shadow-xl transition-all group ${activeTab === 'calculator' ? 'bg-emerald-500/10 border-emerald-500/50' : 'bg-[#0f1219] border-[#1e2635] hover:border-emerald-500/30'}`}
                  >
                    <div className={`text-[7px] sm:text-[8px] uppercase tracking-widest font-bold transition-colors text-center ${activeTab === 'calculator' ? 'text-emerald-400' : 'text-[#62708a] group-hover:text-emerald-400'}`}>Угрозы ФСТЭК</div>
                    <div className="text-2xl sm:text-3xl font-black text-white leading-none">227</div>
                  </button>

                  <button 
                    onClick={() => setActiveTab('vendors')}
                    className={`flex flex-col items-center justify-center gap-1 p-3 sm:p-4 rounded-2xl shadow-xl transition-all group ${activeTab === 'vendors' ? 'bg-emerald-500/10 border-emerald-500/50' : 'bg-[#0f1219] border-[#1e2635] hover:border-emerald-500/30'}`}
                  >
                    <div className={`text-[7px] sm:text-[8px] uppercase tracking-widest font-bold transition-colors text-center ${activeTab === 'vendors' ? 'text-emerald-400' : 'text-[#62708a] group-hover:text-emerald-400'}`}>БАЗА Вендоров</div>
                    <div className="text-2xl sm:text-3xl font-black text-white leading-none">84</div>
                  </button>

                  <button 
                    onClick={() => setActiveTab('experts')}
                    className={`flex flex-col items-center justify-center gap-1 p-3 sm:p-4 rounded-2xl shadow-xl transition-all group ${activeTab === 'experts' ? 'bg-emerald-500/10 border-emerald-500/50' : 'bg-[#0f1219] border-[#1e2635] hover:border-emerald-500/30'}`}
                  >
                    <div className={`text-[7px] sm:text-[8px] uppercase tracking-widest font-bold transition-colors text-center ${activeTab === 'experts' ? 'text-emerald-400' : 'text-[#62708a] group-hover:text-emerald-400'}`}>БАЗА Экспертов</div>
                    <div className="text-2xl sm:text-3xl font-black text-white leading-none">14</div>
                  </button>

                  <div className="flex flex-col items-center justify-center gap-1 p-3 sm:p-4 bg-[#0f1219] border border-[#1e2635] rounded-2xl shadow-xl hover:border-emerald-500/30 transition-all group">
                    <div className="text-[7px] sm:text-[8px] uppercase tracking-widest text-[#62708a] font-bold group-hover:text-emerald-400 transition-colors text-center">Ядро Парето</div>
                    <div className="text-2xl sm:text-3xl font-black text-white leading-none">16</div>
                  </div>
                </div>

                <div className="flex items-center justify-end gap-3">
                  {customFactors !== FACTORS && (
                    <div className="inline-flex items-center gap-2 px-3 py-1 bg-blue-500/10 border border-blue-500/20 rounded-full text-[10px] uppercase tracking-widest text-blue-400 font-bold">
                      <Upload className="w-3 h-3" />
                      Custom Dataset Active
                    </div>
                  )}
                  <div className="inline-flex items-center gap-2 px-3 py-1 bg-emerald-500/10 border border-emerald-500/20 rounded-full text-[10px] uppercase tracking-widest text-emerald-400 font-bold">
                    CIA + AA Standard
                  </div>
                </div>
              </div>
        ...
        {activeTab === 'calculator' ? (
          ...
          <div className="mb-12 flex items-center justify-between">
            ...
            <div className="text-sm font-heading font-bold uppercase tracking-widest text-emerald-400">
              {activeTab === 'vendors' ? 'База проверенных вендоров' : 'База сертифицированных экспертов'}
            </div>
          </div>
        )}
                      ...
                      <div className="flex items-center gap-3 mb-3">
                        ...
                        <div>
                          ...
                          <div className="text-lg font-heading font-bold text-white">
                            ...
                            <span className="text-emerald-400 ml-2">({(results.totalDowntime / 24).toFixed(1)} ДНЕЙ)</span>
                          </div>
                        </div>
                      </div>
        ...
        {activeTab === 'vendors' && (
          ...
          >
            {VENDORS.map(vendor => (
              <div key={vendor.id} className="p-6 bg-[#0f1219] border border-[#1e2635] rounded-3xl hover:border-emerald-500/30 transition-all group">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h3 className="text-lg font-bold text-white group-hover:text-emerald-400 transition-colors">{vendor.name}</h3>
                    <p className="text-xs text-[#62708a] uppercase tracking-widest font-bold">{vendor.category}</p>
                  </div>
                  <div className="flex items-center gap-1 px-2 py-1 bg-emerald-500/10 rounded-lg text-emerald-400 text-[10px] font-bold">
                    <Target className="w-3 h-3" />
                    {vendor.rating}
                  </div>
                </div>
                <div className="flex flex-wrap gap-2 mb-4">
                  {vendor.solutions.map(sol => (
                    <span key={sol} className="px-2 py-1 bg-white/5 rounded-md text-[9px] text-white/60 border border-white/5">
                      {sol}
                    </span>
                  ))}
                </div>
                <a 
                  ...
                  className="inline-flex items-center gap-2 text-[10px] text-blue-400 hover:text-blue-300 transition-colors font-bold uppercase tracking-widest"
                >
        ...
        {activeTab === 'experts' && (
          ...
          >
            {EXPERTS.map(expert => (
              <div key={expert.id} className="p-6 bg-[#0f1219] border border-[#1e2635] rounded-3xl hover:border-emerald-500/30 transition-all group">
                <div className="flex justify-between items-start mb-4">
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-emerald-500/20 to-blue-500/20 flex items-center justify-center text-emerald-400">
                      <User className="w-6 h-6" />
                    </div>
                    <div>
                      <h3 className="text-lg font-bold text-white group-hover:text-emerald-400 transition-colors">{expert.name}</h3>
                      <p className="text-xs text-[#62708a] uppercase tracking-widest font-bold">{expert.role}</p>
                    </div>
                  </div>
                  <div className="px-2 py-1 bg-blue-500/10 rounded-lg text-blue-400 text-[10px] font-bold">
                    {expert.experience}
                  </div>
                </div>
                <div className="flex flex-wrap gap-2 mb-4">
                  {expert.specialization.map(spec => (
                    <span key={spec} className="px-2 py-1 bg-white/5 rounded-md text-[9px] text-white/60 border border-white/5">
                      {spec}
                    </span>
                  ))}
                </div>
